...
export const metadata: Metadata = {
  ...
  description:
    "One Nation. One Game. Six geo-political zones plus the FCT compete for the Golden Champion Trophy in the Presidential Youth Unity Cup (PYUC) — uniting Nigerian youth through football.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Six zones. One FCT. One Golden Champion Trophy. Uniting Nigerian youth through the beautiful game.",
    type: "website",
  },
};
