...
const en = {
  ...
  stRegistered: "Registered Worldwide",
  // Zones
  ...
  bkTbd: "To be decided",
  bkLoserSf1: "Loser SF1",
  bkLoserSf2: "Loser SF2",
  bkPhaseNote: "Registration phase — the draw and fixtures follow once teams are confirmed",
  // Trophy
  ...
  fixturesProvisional: "Provisional",
  fixturesNote: "Illustrative fixtures only — the official draw and confirmed dates follow the close of registration.",
  // Gallery
  ...
  regResState: "State of residence",
  regSelectState: "Select state",
  regLgaField: "L.G.A.",
  regSelectLga: "Select L.G.A.",
  regSelectStateFirst: "Select a state first",
...
const pcm: Dict = {
  ...
  bkLoserSf1: "Loser SF1",
  bkLoserSf2: "Loser SF2",
  bkPhaseNote: "Na registration phase — draw and fixtures go follow once teams confirm",
  ...
  fixturesProvisional: "Provisional",
  fixturesNote: "Na sample fixtures — di official draw and confirmed dates go follow after registration close.",
  ...
  regResState: "State wey you dey stay",
  regSelectState: "Choose state",
  regLgaField: "L.G.A.",
  regSelectLga: "Choose L.G.A.",
  regSelectStateFirst: "Choose state first",
...
const ha: Dict = {
  ...
  regResState: "Jihar zama",
  regSelectState: "Zaɓi jiha",
  regLgaField: "Ƙaramar Hukuma",
  regSelectLga: "Zaɓi ƙaramar hukuma",
  regSelectStateFirst: "Fara zaɓi jiha",
...
const yo: Dict = {
  ...
  stRegistered: "Tó Ti Forúkọsílẹ̀",
  ...
  regResState: "Ìpínlẹ̀ tí o ń gbé",
  regSelectState: "Yan ìpínlẹ̀",
  regLgaField: "Ìjọba Ìbílẹ̀",
  regSelectLga: "Yan ìjọba ìbílẹ̀",
  regSelectStateFirst: "Kọ́kọ́ yan ìpínlẹ̀",
...
const ig: Dict = {
  ...
  regResState: "Steeti obibi",
  regSelectState: "Họrọ steeti",
  regLgaField: "Ọ́gọ̀ Ìme Obodo",
  regSelectLga: "Họrọ ọ́gọ̀ ìme obodo",
  regSelectStateFirst: "Buru ụzọ họrọ steeti",
